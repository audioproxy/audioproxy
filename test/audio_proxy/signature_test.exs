defmodule AudioProxy.SignatureTest do
  ...
  #
  # The hex below is the same material as `SignedRequest.key/0` and `salt/0`,
  # spelled out rather than referenced because the point of the recipe is that
  # it can be pasted into a Python prompt and run. If those two ever change,
  # these vectors have to be regenerated — the tests below will say so.
  #
