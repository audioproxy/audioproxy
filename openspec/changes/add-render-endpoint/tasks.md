...
- [ ] 3.2 Full-stack (`@tag :ffmpeg`): fixture WAV from a local fixture dir (`AP_LOCAL_ROOT`) → decodable mp3/opus; first-chunk-before-completion timing (coalesced-client byte-equality test moves to `add-render-coalescing`)
