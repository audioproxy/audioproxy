...
- **Stat in the action, not a plug** — the info endpoint will share the plugs but wants stat *after* deciding what it's serving (conditional requests short-circuit it); keeping plugs I/O-free preserves that reuse.
